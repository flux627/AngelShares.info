...
<? include('templates/top.php') ?>
	...
	<div id="content">
		<h2>AngelShares Masterbook - ProtoShares</h2>
		<div id = "btcpts">
			<span id = "pts"><a href = "masterbook.php">Switch to BTC</a></span>
		</div>
		<div id = "btc">
			<div id = "pagenav">
			...
			<?
			$btc = curl('http://angelshares.info/beta/json/?allAddressesPaginated');
			$btc = $btc['PTS'];
			$pages = count($btc);
			for ($i = 1; $i <= $pages; $i++) {
