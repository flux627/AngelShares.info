...
$(document).ready(function() {
	...
	function draw_api_output() {
		...
		*/
		...
		var tablething = "<table style = 'width: 100%'><tr><th>Address (click for detailed info)</th><th>txid</th><th>Amount (PTS)</th><th>Block</th><th>Time</th></tr>";
		$.each(current_page_data, function(index, element){
		   tablething += "<tr>";
		   $.each(element, function(index, element) {
...
<div id="content">
<h2>ProtoShares Transactions</h2>
<span style = "margin: 0 0 10px 2px"><a style = "text-decoration: none" href = "transactions.php">Switch to Bitcoin</a></span> <br/><br/>
<div id = "pageNavTop">
